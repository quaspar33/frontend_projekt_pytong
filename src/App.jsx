...
function App() {
  ...
  return (
      <div className="relative bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 h-screen">
          ...
          <div className="flex justify-center items-center">
              <button
                  className="mt-6 px-4 py-2 text-violet-950 font-semibold rounded-md border border-violet-950 hover:bg-gray-300 transition duration-300 ease-in-out transform hover:scale-105">
                  Wyślij dane
              </button>
          </div>
